...
# === Output directory ===
OUTPUT_DIR="outputs/linca_v4_two_stage_2048512512_b10${NUM_BLOCKS}_h${HIDDEN_DIM}"
EXP_NAME="two_stage_2048512512_v4_b10${NUM_BLOCKS}_h${HIDDEN_DIM}"
WANDB_PROJECT="linca_v4_two_stage_2048512512_3512_b10"

...
def main():
    ...
    parser.add_argument('--data_dir', type=str, default='/root/autodl-tmp/linca_data/data/cache_data')
    ...
    val_sample_range = parse_indices(args.val_sample_range)
    val_rng = random.Random(42)
    num_val = min(args.num_val_prompts, len(val_sample_range))
    val_indices = sorted(val_rng.sample(val_sample_range, num_val))
